...
function init_gear_sets()
	...
	sets.precast.CorsairRoll = {main="Rostam",range="Compensator",neck="Regal Necklace",back=gear.str_wsd_jse_back,legs="Desultor Tassets"}
	...
	sets.precast.CorsairShot.Proc = {ammo=gear.RAbullet,
		...
		back="Null Shawl",waist="Flume Belt +1",legs="Carmine Cuisses +1",feet="Chass. Bottes +1"}
