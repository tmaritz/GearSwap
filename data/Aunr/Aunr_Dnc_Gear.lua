...
function init_gear_sets()
	...
	sets.precast.WS.Proc = {ammo="Yamarang",
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs="Dashing Subligar",feet="Ahosi Leggings"}
    ...
    sets.precast.WS['Evisceration'] = set_combine(sets.precast.WS, {ammo="Charis Feather",head="Adhemar Bonnet",neck="Fotia Gorget",body="Abnoba Kaftan",hands="Mummu Wrists +2",ring1="Begrudging Ring",waist="Fotia Belt",feet="Mummu Gamash. +2"})
    ...
    sets.engaged.DTLite = {ammo="Yamarang",
        ...
        body="Adhemar Jacket +1",hands="Adhemar Wristbands",ring1="Defending Ring",ring2="Epona's Ring",
        back=gear.stp_jse_back,waist="Windbuffet Belt +1",legs="Samnuha Tights",feet=gear.herculean_ta_feet}
    ...
    sets.engaged.PDT = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs="Meg. Chausses +2",feet="Ahosi Leggings"}
    ...
    sets.engaged.Fodder.PDT = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs="Meg. Chausses +2",feet="Malignance Boots"}
