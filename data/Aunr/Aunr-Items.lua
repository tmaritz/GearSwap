...
gear.nibiru_b_sword = {name="Nibiru Blade", augments={'STR+10','Attack+20','"Store TP"+3',}}
...
gear.herculean_ta_feet = {name="Herculean Boots",augments={'Mag. Acc.+11','Rng.Atk.+23','Quadruple Attack +3',}}
gear.herculean_refresh_feet = {name="Herculean Boots",augments={'CHR+2','MND+6','"Refresh"+2','Accuracy+7 Attack+7',}}
gear.herculean_wsd_feet = {name="Herculean Boots",augments={'"Store TP"+2','STR+1','Weapon skill damage +7%','Accuracy+18 Attack+18',}}
...
gear.taeon_pet_head={ name="Taeon Chapeau", augments={'Pet: Accuracy+15 Pet: Rng. Acc.+15','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}
gear.taeon_pet_body={ name="Taeon Tabard", augments={'Pet: Accuracy+19 Pet: Rng. Acc.+19','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}
gear.taeon_pet_hands={ name="Taeon Gloves", augments={'Pet: Accuracy+22 Pet: Rng. Acc.+22','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}
gear.taeon_pet_legs={ name="Taeon Tights", augments={'Pet: Accuracy+20 Pet: Rng. Acc.+20','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}
gear.taeon_pet_feet={ name="Taeon Boots", augments={'Pet: Accuracy+23 Pet: Rng. Acc.+23','Pet: "Dbl. Atk."+5','Pet: Damage taken -4%',}}
