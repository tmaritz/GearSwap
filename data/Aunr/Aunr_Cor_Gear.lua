...
function init_gear_sets()
	...
	sets.precast.CorsairShot.Damage = {ammo=gear.QDbullet,
        ...
        body="Samnuha Coat",hands="Leyline Gloves",ring1="Shiva Ring",ring2="Dingir Ring",
    ...
    sets.precast.CorsairShot.Proc = {ammo=gear.RAbullet,
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs="Carmine Cuisses +1",feet="Chass. Bottes +1"}

    sets.precast.CorsairShot['Light Shot'] = {ammo=gear.QDbullet,
        head="Carmine Mask +1",neck="Sanctity Necklace",ear1="Digni. Earring",ear2="Telos Earring",
        body="Mummu Jacket +2",hands="Leyline Gloves",ring1="Metamor. Ring +1",ring2="Stikini Ring",
    ...
    sets.precast.WS = {
        ...
        body="Laksa. Frac +3",hands="Meg. Gloves +2",ring1="Regal Ring",ring2="Ifrit Ring",
    ...
    sets.precast.WS['Requiescat'] = set_combine(sets.precast.WS, {head="Carmine Mask +1",ring2="Chirich Ring",legs="Carmine Cuisses +1",feet="Carmine Greaves +1"})
    ...
    sets.precast.WS['Savage Blade'].Acc = {ammo=gear.WSbullet,
        ...
        body="Meg. Cuirie +2",hands="Meg. Gloves +2",ring1="Regal Ring",ring2="Chirich Ring",
        back=gear.str_wsd_jse_back,waist="Grunfeld Rope",legs="Carmine Cuisses +1",feet="Lanun Bottes +3"}
    ...
    sets.idle = {ammo=gear.RAbullet,
        ...
        back="Solemnity Cape",waist="Carrier's Sash",legs="Carmine Cuisses +1",feet="Malignance Boots"}
    ...
    sets.engaged.Acc = {
		...
		body="Meg. Cuirie +2",hands="Adhemar Wristbands",ring1="Epona's Ring",ring2="Ramuh Ring +1",
		back=gear.tp_jse_back,waist="Olseni Belt",legs="Carmine Cuisses +1",feet="Malignance Boots"}
