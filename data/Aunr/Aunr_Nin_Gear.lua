...
function init_gear_sets()
    ...
    sets.Enmity = {ammo="Paeapua",
        ...
        back="Solemnity Cape",waist="Goading Belt",legs=gear.herculean_dt_legs,feet="Amm Greaves"}
    ...
    sets.precast.WS = {ammo="Voluspa Tathlum",
        ...
        body="Adhemar Jacket +1",hands="Adhemar Wristbands",ring1="Ilabrat Ring",ring2="Regal Ring",
    ...
    sets.precast.WS['Blade: Jin'] = set_combine(sets.precast.WS, {ammo="Yetshila +1",head="Adhemar Bonnet",ammo="Yetshila +1",head="Adhemar Bonnet",body="Abnoba Kaftan",hands="Ryuo Tekko",ring1="Begrudging Ring",waist="Grunfeld Rope",legs="Mummu Kecks +2",feet="Mummu Gamash. +2"})
	...
	sets.precast.WS['Blade: Hi'] = set_combine(sets.precast.WS, {ammo="Yetshila +1",head="Adhemar Bonnet",ear1="Moonshade Earring",ear2="Brutal Earring",body="Abnoba Kaftan",hands="Ryuo Tekko",ring1="Begrudging Ring",back=gear.wsd_jse_back,legs="Hiza. Hizayoroi +2",feet="Mummu Gamash. +2"})
    ...
    sets.midcast.NinjutsuDebuff = {ammo="Dosis Tathlum",
        ...
        body="Mekosu. Harness",hands="Mochizuki Tekko +1",ring1="Stikini Ring",ring2="Metamor. Ring +1",
    ...
    sets.defense.PDT = {ammo="Togakushi Shuriken",
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs=gear.herculean_dt_legs,feet="Malignance Boots"}
    ...
    sets.engaged = {ammo="Seki Shuriken",
        ...
        body="Ken. Samue",hands="Adhemar Wristbands",ring1="Gere Ring",ring2="Epona's Ring",
