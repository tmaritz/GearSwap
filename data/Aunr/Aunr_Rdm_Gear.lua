...
function init_gear_sets()
	...
	sets.precast.FC = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap",range=empty,ammo="Impatiens",
	...
	sets.precast.WS['Requiescat'] = {range=empty,ammo="Regal Gem",
		...
		body="Jhakri Robe",hands="Atrophy Gloves +3",ring1="Ifrit Ring",ring2="Chirich Ring",
		back=gear.wsd_jse_back,waist="Fotia Belt",legs="Jhakri Slops",feet="Jhakri Pigaches"}
	...
	sets.precast.WS['Savage Blade'] = {range=empty,ammo="Regal Gem",
		...
		body="Viti. Tabard +3",hands="Atrophy Gloves +3",ring1="Ifrit Ring",ring2="Chirich Ring",
		back=gear.wsd_jse_back,waist="Sailfi Belt +1",legs="Jhakri Slops",feet="Jhakri Pigaches"}
	...
	sets.precast.WS['Sanguine Blade'] = {range=empty,ammo="Pemphredo Tathlum",
		...
		body=gear.merlinic_nuke_body,hands="Jhakri Cuffs",ring1="Metamor. Ring +1",ring2="Archon Ring",
	...
	sets.precast.WS['Seraph Blade'] = {range=empty,ammo="Pemphredo Tathlum",
		...
		body=gear.merlinic_nuke_body,hands="Jhakri Cuffs",ring1="Shiva Ring",ring2="Freke Ring",
		back=gear.nuke_jse_back,waist="Refoccilation Stone",legs="Merlinic Shalwar",feet=gear.merlinic_nuke_feet}
		
	sets.precast.WS['Aeolian Edge'] = {range=empty,ammo="Pemphredo Tathlum",
		head=gear.merlinic_nuke_head,neck="Baetyl Pendant",ear1="Regal Earring",ear2="Malignance Earring",
		body=gear.merlinic_nuke_body,hands="Jhakri Cuffs",ring1="Metamor. Ring +1",ring2="Freke Ring",
		back=gear.nuke_jse_back,waist="Refoccilation Stone",legs="Merlinic Shalwar",feet=gear.merlinic_nuke_feet}
    ...
    sets.MagicBurst = {main=gear.grioavolr_nuke_staff,sub="Alber Strap",head="Ea Hat",neck="Mizu. Kubikazari",body="Ea Houppelande",hands="Amalric Gages",ring1="Mujin Band",legs="Ea Slops",feet="Jhakri Pigaches"}
	
	sets.midcast.FastRecast = {main=gear.grioavolr_fc_staff,sub="Clerisy Strap",range=empty,ammo="Hasty Pinion +1",
		head="Atrophy Chapeau +3",neck="Voltsurge Torque",ear1="Enchntr. Earring +1",ear2="Malignance Earring",
	...
	sets.midcast['Enhancing Magic'] = {main="Colada",sub="Ammurapi Shield",range=empty,ammo="Hasty Pinion +1",
		...
		body="Viti. Tabard +3",hands="Atrophy Gloves +3",ring1="Stikini Ring",ring2="Stikini Ring",
	...
	sets.midcast['Enfeebling Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head="Viti. Chapeau +3",neck="Dls. Torque +2",ear1="Regal Earring",ear2="Snotra Earring",
		body="Atrophy Tabard +3",hands=gear.chironic_enfeeble_hands,ring1="Metamor. Ring +1",ring2="Stikini Ring",
		back=gear.nuke_jse_back,waist="Luminary Sash",legs="Chironic Hose",feet="Vitiation Boots +3"}
    ...
    sets.midcast['Elemental Magic'] = {main="Daybreak",sub="Ammurapi Shield",range=empty,ammo="Dosis Tathlum",
        ...
        body=gear.merlinic_nuke_body,hands="Amalric Gages",ring1="Shiva Ring",ring2="Freke Ring",
    ...
    sets.midcast['Elemental Magic'].Resistant = {main="Daybreak",sub="Ammurapi Shield",ammo="Pemphredo Tathlum",
        ...
        body=gear.merlinic_nuke_body,hands="Amalric Gages",ring1="Metamor. Ring +1",ring2="Freke Ring",
	...
	sets.midcast['Dark Magic'] = {main="Rubicundity",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		...
		body="Atrophy Tabard +3",hands="Leth. Gantherots +1",ring1="Metamor. Ring +1",ring2="Stikini Ring",
	...
	sets.midcast.Stun.Resistant = {main="Daybreak",sub="Ammurapi Shield",range="Kaja Bow",ammo=empty,
		head="Atrophy Chapeau +3",neck="Dls. Torque +2",ear1="Regal Earring",ear2="Malignance Earring",
		body="Atrophy Tabard +3",hands="Volte Gloves",ring1="Metamor. Ring +1",ring2="Stikini Ring",
	...
	sets.resting = {main="Chatoyant Staff",sub="Oneiros Grip",range=empty,ammo="Impatiens",
		...
		body="Jhakri Robe",hands=gear.merlinic_refresh_hands,ring1="Defending Ring",ring2="Sheltered Ring",
