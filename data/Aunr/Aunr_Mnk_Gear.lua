...
function init_gear_sets()
	...
	sets.precast.WS = {ammo="Voluspa Tathlum",
		...
		body="Ken. Samue",hands="Adhemar Wristbands",ring1="Niqmaddu Ring",ring2="Gere Ring",
	...
	sets.midcast.FastRecast = {ammo="Staunch Tathlum",
		...
		back="Solemnity Cape",waist="Black Belt",legs=gear.herculean_dt_legs,feet="Hippo. Socks +1"}
	...
	sets.defense.PDT = {ammo="Staunch Tathlum",
		head="Genmei Kabuto",neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Sanare Earring",
		body="Malignance Tabard",hands="Malignance Gloves",ring1="Defending Ring",ring2="Dark Ring",
		back="Solemnity Cape",waist="Black Belt",legs=gear.herculean_dt_legs,feet="Malignance Boots"}
	...
	sets.defense.MDT = {ammo="Staunch Tathlum",
		...
		back="Solemnity Cape",waist="Flax Sash",legs=gear.herculean_dt_legs,feet="Hippo. Socks +1"}
