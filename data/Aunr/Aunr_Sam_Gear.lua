...
function init_gear_sets()
    ...
    sets.midcast.FastRecast = {
        ...
        back="Solemnity Cape",waist="Tempus Fugit",legs="Wakido Haidate +3",feet="Amm Greaves"}
    ...
    sets.resting = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs="Wakido Haidate +3",feet="Flam. Gambieras +2"}
    ...
    sets.idle = {ammo="Staunch Tathlum",
        head=gear.valorous_wsd_head,neck="Loricate Torque +1",ear1="Etiolation Earring",ear2="Sanare Earring",
        body="Hiza. Haramaki +2",hands="Sakonji Kote +1",ring1="Defending Ring",ring2="Dark Ring",
        back="Solemnity Cape",waist="Flume Belt +1",legs="Flamma Dirs +2",feet="Danzo Sune-ate"}
    ...
    sets.defense.PDT = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Ioskeha Belt",legs="Wakido Haidate +3",feet="Amm Greaves"}
    ...
    sets.defense.MDT = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Flax Sash",legs="Wakido Haidate +3",feet="Amm Greaves"}
...
--[[Right now Adoulin sets are the same as non-Adoulin.
    ...
    sets.engaged.Adoulin.PDT = {ammo="Staunch Tathlum",
        ...
        back="Solemnity Cape",waist="Flume Belt +1",legs="Wakido Haidate +3",feet="Amm Greaves"}
    sets.engaged.Adoulin.SomeAcc.PDT = {ammo="Staunch Tathlum",
        ...
        head="Flam. Zucchetto +2",neck="Loricate Torque +1",ear1="Cessance Earring",ear2="Brutal Earring",
        body="Tartarus Platemail",hands=gear.valorous_wsd_hands,ring1="Defending Ring",ring2="Patricius Ring",
        back="Solemnity Cape",waist="Olseni Belt",legs="Wakido Haidate +3",feet="Amm Greaves"}
